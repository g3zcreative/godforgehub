...
const databaseCategories = [
  ...
  { id: "items", name: "Items", description: "Weapons, armor & accessories", icon: "Sword", href: "/database/items" },
  { id: "skills", name: "Skills", description: "Hero abilities & passives", icon: "Zap", href: "/database/skills" },
  { id: "materials", name: "Materials", description: "Crafting & upgrade materials", icon: "Gem", href: "/database/materials" },
];
